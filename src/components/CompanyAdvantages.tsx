...
const CompanyAdvantages = () => {
  const advantages = [
    ...
    {
      icon: Shield,
      title: 'Четыре направления деятельности',
      description:
        'Совместные проекты в области поставок оборудования, металлургического сырья, промышленных печей и производственной кооперации с отдельным юридическим лицом ВСЗ.',
      stat: '4 направления',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto" itemProp="description">
            B2B-партнёр в поставках промышленного оборудования, металлургического сырья и в
            производственной кооперации. Конкретные условия по каждому направлению фиксируются в договоре.
          </p>
        </div>
