  ...
  const businessDirections = [
    {
      ...
      description: 'CNC machines, robotic systems',
      color: 'text-primary'
    },
    {
      icon: Factory,
      title: 'Metallurgical Raw Materials',
      description: 'Ores, ferroalloys, alloying materials',
      color: 'text-accent'
    },
    {
      icon: Flame,
      title: 'Metallurgical Furnaces',
      description: 'Vacuum, induction, gas furnaces',
      color: 'text-secondary'
    },
    {
      icon: Building2,
      title: 'VSZ Production',
      description: 'Metalworking, parts manufacturing',
      color: 'text-primary'
    }
  ];
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        ...
        <div className="absolute bottom-0 right-0 w-80 animate-industrial-fade-in hidden lg:block z-20">
          <div className="bg-white/15 backdrop-blur-md rounded-2xl p-6 border border-white/30 shadow-2xl">
            <h3 className="text-xl font-bold text-white mb-4">Business Areas</h3>
