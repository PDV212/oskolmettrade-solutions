...
const serviceSchemas = [
  ...
  },
  {
    ...
    areaServed: ['RU'],
    description:
      'Категории печного оборудования: вакуумно-дуговые, индукционные и газовые печи. Тип, ёмкость, мощность и интеграция определяются по техническому заданию и подтверждаются документацией выбранного производителя.',
  },
  {
    '@context': 'https://schema.org',
    '@type': 'Service',
