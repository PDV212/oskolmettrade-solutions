...
export const businessDirections: BusinessDirection[] = [
  {
    ...
    subtitle: {
      ru: 'Подбор и организация поставки',
      en: 'Selection and supply coordination',
      zh: '设备选型与供货协调',
    },
    description: {
      ru: 'Подбор и организация поставки металлообрабатывающего оборудования для машиностроительных и металлургических предприятий. Конфигурация, производитель, автоматизация и состав проекта определяются по техническому заданию и фиксируются в коммерческом предложении и договоре.',
      en: 'Selection and supply coordination of metalworking equipment for mechanical engineering and metallurgical enterprises. The configuration, manufacturer, automation scope and project composition are determined from the technical requirements and specified in the commercial proposal and contract.',
      zh: '为机械制造和冶金企业提供金属加工设备选型及供货协调服务。设备配置、制造商、自动化范围及项目组成根据技术要求确定，并在商务报价和合同中明确。',
    },
    ...
    features: [
      {
        ...
        label: {
          ru: 'Основные категории оборудования',
      ...
      },
      {
        ...
        evidenceStatus: 'owner-confirmed-direction',
        label: {
          ru: 'Вертикальные и горизонтальные обрабатывающие центры с ЧПУ',
          en: 'Vertical and horizontal CNC machining centers',
          zh: '立式与卧式数控加工中心',
        },
      },
      {
        ...
        evidenceStatus: 'owner-confirmed-direction',
        label: {
          ru: 'Токарные обрабатывающие центры с ЧПУ',
      ...
      },
      {
        ...
        evidenceStatus: 'owner-confirmed-direction',
        label: {
          ru: 'Роботизированные системы сварки и покраски — состав и уровень автоматизации согласуются по проекту.',
          en: 'Robotic welding and painting systems — scope and automation level are agreed per project.',
          zh: '机器人焊接与喷涂系统 — 具体范围与自动化程度按项目协商确定。',
        },
      },
      {
        ...
        evidenceStatus: 'owner-confirmed-direction',
        label: {
          ru: 'Автоматизированные металлорежущие комплексы с системами подачи заготовки и приёма готового изделия — по техническому заданию.',
          en: 'Automated metal-cutting systems with workpiece feeding and finished-part handling — subject to technical requirements.',
          zh: '带上料与成品接收系统的自动化金属切削生产线 — 依据技术要求。',
        },
      },
    ],
  },
